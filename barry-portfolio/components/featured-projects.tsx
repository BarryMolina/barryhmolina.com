...
const projects = [
  ...
  },
  {
    ...
    description: "AI-powered content generation tool using OpenAI API with custom fine-tuning and user management.",
  ...
  },
  {
    ...
    description: "High-performance analytics dashboard with real-time data visualization and custom reporting.",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl">
            A selection of recent projects showcasing technical expertise across various technologies and problem
            domains.
          </p>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tech.map((tech, techIndex) => (
                    <Badge key={techIndex} variant="secondary" className="bg-white/10 text-white border-0">
                      {tech}
                    </Badge>
                  ))}
                </div>
