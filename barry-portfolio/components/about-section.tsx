...
export function AboutSection() {
  return (
    <section id="about" className="py-24 px-4 sm:px-6 lg:px-8 bg-black text-white">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-lg text-gray-400 leading-relaxed">
                <p>
                  ...
                  and solving complex technical challenges. My expertise spans full-stack development, cloud
                  architecture, and modern DevOps practices.
                </p>
                <p>
                  I believe in writing clean, maintainable code and staying current with emerging technologies. When I'm
                  not coding, you'll find me contributing to open source projects, writing technical blog posts, or
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                {skills.map((skill, index) => (
                  <Badge key={index} variant="secondary" className="bg-white/10 text-white border-0 text-sm py-2 px-4">
                    {skill}
                  </Badge>
                ))}
              </div>
